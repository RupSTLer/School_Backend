package com.springproject.sms.config;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception
	{
		...
		httpSecurity.csrf().disable()  //to disable CSRF attacks
					.authorizeRequests().antMatchers("/authenticate","/registerNewUser","/createNewRole","/student/message/create","/student/message/msg","/student/addStudent").permitAll()
